import {
  type CharacterDescriptionRefineRequest,
  characterDescriptionRefineRequestSchema,
  type CharacterDescriptionRequest,
  characterDescriptionRequestSchema,
  type CharacterDescriptionResponse,
...
export const characterDescriptionRoute = new Elysia()
  .post(
    ...
    {
      body: characterDescriptionRequestSchema,
      response: {
        200: characterDescriptionResponseSchema,
        401: t.String(),
        403: t.String(),
      },
    },
  ...
  .post(
    ...
    {
      body: characterDescriptionRefineRequestSchema,
      response: {
        200: characterDescriptionResponseSchema,
        401: t.String(),
        403: t.String(),
