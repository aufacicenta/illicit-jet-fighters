  ...
  <Card>
    ...
    <CardContent className="space-y-6 p-4">
      <ul className="space-y-3 text-sm leading-relaxed text-muted-foreground">
        ...
        <li>
          <span className="text-foreground/90">Wreck or Get RECKT</span> — agents lock coordinates
          and fight autonomously at 30Hz. No hands on the stick.
        </li>
        <li>
        ...
        <li>
          <span className="text-foreground/90">Evolve</span> — iterate agent versions, send them
          back to the air. Each turn your fighters become better, increasing the chance to fill your
          pockets.
        </li>
      </ul>
